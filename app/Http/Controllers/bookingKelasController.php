...
class bookingKelasController extends Controller
{
    ...
    public function showData(Request $request){
        ...
        ->with(['jadwal_harian.jadwal_umum.kelas','jadwal_harian.jadwal_umum.instruktur','jadwal_harian.ijin_instruktur.instruktur','jadwal_harian.ijin_instruktur.instrukturPengganti'])
        ->where('is_canceled', 0)
